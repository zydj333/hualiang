...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <div class="result-content">
            <form method="post" id="link_edit_form" name="myform" enctype="multipart/form-data">
                <table class="insert-tab" width="100%">
                    ...
                    <tr>
                        <th>网站链接：</th>
                        <td><input class="common-text" name="url" size="50" type="text" value="<?php echo $link->url ?>"></td>
                    </tr>
                    <tr>
                        <th>更改图片：</th>
                    ...
                    <tr>
                        <th>原图片：</th>
                        <td><img src="<?php echo base_url().'/'.$link->imageurl ?>" /></td>
                    </tr>
                    <tr>
                        <th>排序：</th>
                        <td><input class="common-text" name="listorder" size="50" type="text" value="<?php echo $link->listorder ?>"></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
                            <input class="btn btn-primary btn6 mr10" id='link_edit_button' value="提交" type="button">
                        </td>
                    </tr>
                    </tbody></table>
            </form>
